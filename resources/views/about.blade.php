...
@section("content")
    ...
    <div class="d-flex">
        ...
        <div>
            <p><a href="https://educurio.sharepoint.com/:b:/r/sites/Studentenportaal/tt_belangrijkedocumenten/Schooljaar%202021-2022/CTT_presentie_verzuimprotocol_student_2021-2022_V2.pdf?csf=1&web=1&e=1qXHu0" target="_blank">Verzuimprotocol <i class="fas fa-external-link-alt"></i></a></p>
